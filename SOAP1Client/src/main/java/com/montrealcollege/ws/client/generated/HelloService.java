 ...
 * 
 */
@WebServiceClient(name = "HelloService", targetNamespace = "http://www.example.org/hello", wsdlLocation = "http://localhost:8080/Exercise1SOAP/hello.wsdl")
    ...
    extends Service
{
    ...
    private final static QName HELLOSERVICE_QNAME = new QName("http://www.example.org/hello", "HelloService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("http://localhost:8080/Exercise1SOAP/hello.wsdl");
     ...
     *     returns Hello
     */
    @WebEndpoint(name = "HelloSoap11")
    public Hello getHelloSoap11() {
        return super.getPort(new QName("http://www.example.org/hello", "HelloSoap11"), Hello.class);
    }
     ...
     */
    @WebEndpoint(name = "HelloSoap11")
    public Hello getHelloSoap11(WebServiceFeature... features) {
        return super.getPort(new QName("http://www.example.org/hello", "HelloSoap11"), Hello.class, features);
    }
